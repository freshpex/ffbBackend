...
router.post('/profile/image', UserProfileController.upload.single('image'), asyncHandler(UserProfileController.uploadProfileImage));
...
router.post('/security/2fa/verify', asyncHandler(UserSecurityController.verify2FA));
router.post('/security/2fa/disable', asyncHandler(UserSecurityController.disable2FA));
router.get('/security/login-activity', asyncHandler(UserSecurityController.getLoginActivity));
router.get('/security/status', asyncHandler(UserSecurityController.getSecurityStatus));
